...
use crate::ToolExecutionDomainKind;
...
pub trait HostedAgentService: Send + Sync {
    /// Stable, non-secret service/tenant identity used to bind the private journal.
    /// Implementations without credentials may rely on their concrete type identity.
    fn state_scope(&self) -> String {
