...
{ "method": "thread/start", "id": 10, "params": {
    ...
    "model": "gpt-5.1-codex",
    // Experimental hosted-agent role; omit for the configured default:
